<script lang="ts">
    ...
    import type { FormReport } from "../types/FormReport"
    //
...
console.log(FirstDay+'*'+LastDay)
    ...
    const saveAnswer = () => {
        ...
        fetch(urlAPI + "?ref=save-form-answer" + "&date1=" +
                date1 + "&date2=" + date2, {
...
<div class="p-3 w-full">
    ...
    <input type="date" class="inputA mr-4" bind:value={date1}> <input type="date" class="inputA mr-4" bind:value={date2}> <button class="btn-primary mr-2 flex whitespace-nowrap" on:click={listF}>
        <svg
            ...
            <tbody>
                {#each listForm as fm, i}
                    <tr class="bg-white border-b hover:bg-aliceblue">
                        ...
                        <td>
                            <textarea class="inputA" bind:value={fm.response}></textarea>
                            </td>
