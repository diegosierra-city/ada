	...
	<div class="relative overflow-x-auto shadow-md sm:rounded-lg w-full">
		...
		<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
			<thead class="text-xs text-white uppercase bg-primary dark:bg-gray-700 dark:text-gray-400">
				...
				<th scope="col" class="px-4 py-2"> Footer </th>
				<th scope="col" class="px-4 py-2"> Side </th>
				<th scope="col" class="px-4 py-2"> Position </th>
				{#if submenu_show}
					<th scope="col" class="px-4 py-2"> Submenu </th>
				{/if}

				<th scope="col" class="px-4 py-2"> SEO </th>
				<th scope="col" class="px-4 py-2" />
				<th scope="col" class="px-4 py-2" />
			</thead>
			<tbody>
						...
						<tr>
							<td colspan="4">
								...
								<input
									...
									class="inputA w-full"
									rows="10"
									bind:value={mn.metadescription}
								/>
							</td>
							<td colspan="8">
								<span class="font-bold">Meta Key Words:</span><br />
								<input type="text" class="inputA w-full" rows="10" bind:value={mn.metakeywords} />
							</td>
						</tr>
					{/if}
