<script lang="ts">
	...
	const loadContent = (id: number) => {
		...
		fetch(
			urlAPI +
				'?ref=loadID&folder=content_blocks&field=menu_id&id=' +
				id +
				'&user_id=' +
				$userNow.id +
				'&time=' +
	...
	const saveCont = (id: number) => {
		//console.log("yy:" + content.id);
		if (id > 0) {
			fetch(urlAPI + '?ref=save-content', {
				...
				.then((result) => {
					...
					if (result.error) {
						...
						content = result[0];
						//console.log("cargado contenido, menu_id:"+id);
	...
	function upload(id: number, position: number) {
		...
		fetch(urlAPI + '?ref=upload&folder=pages&prefix=', {
			method: 'POST',
			body: dataArray
		})
			.then((response) => response.json())
	...
	function uploadGallery(g: Gallery, position:number) {
		...
		fetch(urlAPI + '?ref=upload&folder=gallery', {
			method: 'POST',
			body: dataArray
		})
			.then((response) => response.json())
	...
	<div class="bg-edit">
		<div class="edit-page">
			...
			<div aria-label="form" tabindex="0" class="focus:outline-none xl:w-10/12 w-full ">
				<div class="xl:px-8">
							...
							<div class="md:flex items-center lg:ml-24">
								<div class="md:w-64 mx-2">
									...
									{:else if content.image1 != ''}
										<img src="{urlFiles}/images/pages/M{content.image1}" alt={page_name} /> <br />
										<button
											class="btn-red flex"
											on:click={() => {
												content.image1 = '';
								...
								<div class="md:w-64 mx-2">
									...
									{:else if content.image2 != ''}
										<img src="{urlFiles}/images/pages/M{content.image2}" alt={page_name} /> <br />
										<button
											class="btn-red flex"
											on:click={() => {
												content.image2 = '';
							...
							<div class="md:flex items-center lg:ml-24">
								<div class="md:w-64 mx-2">
									...
									{:else if content.image3 != ''}
										<img src="{urlFiles}/images/pages/M{content.image3}" alt={page_name} /> <br />
										<button
											class="btn-red flex"
											on:click={() => {
												content.image3 = '';
								...
								<div class="md:w-64 mx-2">
									...
									{:else if content.image4 != ''}
										<img src="{urlFiles}/images/pages/M{content.image4}" alt={page_name} /> <br />
										<button
											class="btn-red flex"
											on:click={() => {
												content.image4 = '';
								...
								<div class="grid grid-cols-1 md:grid-cols-2 md:gap-4 lg:ml-24">
									{#each listGalleries as galle, i}
										<div class="mx-2">
											...
											{:else if galle.image != ''}
												<img
													src="{urlFiles}/images/gallery/M{galle.image}"
													alt={page_name}
													class="w-full h-auto"
												/> <br />
												<button
